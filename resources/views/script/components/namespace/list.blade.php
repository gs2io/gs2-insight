<div class="bg-gray-100 shadow-sm rounded-lg">
    <div class="p-6 justify-between items-center">
        @include('script/components/namespace/search', [
            'url' => url()->current(),
        ])
    </div>
                            ...
                            @foreach ($namespaces as $namespace)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ url()->current() . "/script/$namespace->namespaceName" }}" class="text-indigo-600 hover:text-indigo-900">
                                            {{ __('messages.model.script.namespace.action.detail') }}
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
