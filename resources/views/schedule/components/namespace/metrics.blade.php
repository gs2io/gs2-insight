...
<div class="p-6">
    {{ $namespace->eventModelsView("schedule/components/namespace/eventModel/list", request()->eventModelName) }}
</div>

<div class="p-6">
    {{ $namespace->triggerModelsView("schedule/components/namespace/triggerModel/list", request()->triggerModelName) }}
</div>
