...
@section('content')
    ...
    @include('commons.breadcrumb', [
        'hierarchy' => [
            ...
            request()->userId => url("/players/". request()->userId. "?mode=experience"),
            "Experience" => url("/players/". request()->userId. "?mode=experience"),
    ...
    <div class="p-8">
        <div class="bg-white shadow-sm rounded-lg">
            ...
            <div class="m-4 bg-white shadow rounded-lg">
                ...
                {{ $namespace->user(request()->userId)->experiencesView('experience/components/namespace/user/experience/list') }}
            </div>
            <div class="p-2"></div>
        </div>
    </div>
