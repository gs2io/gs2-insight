...
@section('content')
    ...
    @include('commons.breadcrumb', [
        'hierarchy' => [
            ...
            request()->userId => url("/players/". request()->userId. "?mode=inbox"),
            "Inbox" => url("/players/". request()->userId. "?mode=inbox"),
    ...
    <div class="p-8">
        <div class="bg-white shadow-sm rounded-lg">
            ...
            <div class="m-4 bg-white shadow rounded-lg">
                <label class="p-4 block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">
                    {{ __('messages.model.inbox.messages') }}
                </label>
                {{ $namespace->user(request()->userId)->messagesView('inbox/components/namespace/user/message/list') }}
                <div class="p-2"></div>
            </div>
            <div class="p-2"></div>
        </div>
