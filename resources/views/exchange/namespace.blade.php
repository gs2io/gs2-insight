...
@section('content')
    ...
    @include('commons.breadcrumb', [
        'hierarchy' => [
            ...
            request()->userId => url("/players/". request()->userId. "?mode=exchange"),
            "Exchange" => url("/players/". request()->userId. "?mode=exchange"),
    ...
    <div class="p-8">
        <div class="bg-white shadow-sm rounded-lg">
            ...
            <div class="m-4 bg-white shadow rounded-lg">
                <label class="p-4 block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">
                    {{ __('messages.model.exchange.rates') }}
                </label>
                {{ $namespace->user(request()->userId)->ratesView('exchange/components/namespace/user/rate/list') }}
                <div class="p-2"></div>
            </div>
            <div class="p-2"></div>
        </div>
