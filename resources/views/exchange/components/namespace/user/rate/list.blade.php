                            ...
                            @foreach ($rates as $rate)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ url()->current() . "/rate/$rate->rateModelName" }}" class="text-indigo-600 hover:text-indigo-900">
...
{{ $user->rateControllerView('exchange/components/namespace/user/rate/controller') }}
