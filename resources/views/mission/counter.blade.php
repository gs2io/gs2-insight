...
@section('content')
    ...
    @include('commons.breadcrumb', [
        'hierarchy' => [
            ...
            $counter->user->userId => url("/players/". $counter->user->userId. "?mode=mission"),
            "Mission" => url("/players/". $counter->user->userId. "?mode=mission"),
            $counter->user->namespace->namespaceName => url("/players/". $counter->user->userId. "/mission/". $counter->user->namespace->namespaceName),
            "Counter Model" => url("/players/". $counter->user->userId. "/mission/". $counter->user->namespace->namespaceName),
            ...
            <div class="flex">
                ...
                <div class="w-25">
                    <div class="m-4 bg-white shadow rounded-lg">
                        ...
                        {{ $counter->infoView('mission/components/namespace/user/counter/info') }}
                        <div class="p-2"></div>
                    </div>
                </div>
                @endif
