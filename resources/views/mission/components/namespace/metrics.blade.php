...
<div class="p-6">
    {{ $namespace->missionGroupModelsView("mission/components/namespace/missionGroupModel/list", request()->missionGroupModelName) }}
</div>
<div class="p-6">
    {{ $namespace->counterModelsView("mission/components/namespace/counterModel/list", request()->counterModelName) }}
</div>
