<div class="bg-gray-100 shadow-sm rounded-lg">
    <div class="bg-white p-6 justify-between items-center">
                            ...
                            @foreach ($missionTasks as $missionTask)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ url()->current() . "/missionTask/$missionTask->missionTaskModelName" }}" class="text-indigo-600 hover:text-indigo-900">
                                            {{ __('messages.model.mission.missionTask.action.detail') }}
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
        ...
        {{ $missionTasks->appends(request()->input())->links() }}
    </div>
    <div class="p-1"></div>
</div>
