<div class="bg-gray-100 shadow-sm rounded-lg">
    <div class="p-6 justify-between items-center">
        @include('account/components/namespace/search', [
            'url' => url()->current(),
        ])
    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    {{ __('messages.model.account.namespace.name') }}
                                </th>
                            ...
                            @foreach ($namespaces as $namespace)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ url()->current() . "/account/$namespace->namespaceName" }}" class="text-indigo-600 hover:text-indigo-900">
