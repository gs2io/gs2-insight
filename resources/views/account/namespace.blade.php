...
@section('content')
    ...
    @include('commons.breadcrumb', [
        'hierarchy' => [
            ...
            request()->userId => url("/players/". request()->userId. "?mode=account"),
            "Account" => url("/players/". request()->userId. "?mode=account"),
    ...
    <div class="p-8">
        <div class="bg-white shadow-sm rounded-lg">
            ...
            <div class="m-4 bg-white shadow rounded-lg">
                ...
                {{ $namespace->user(request()->userId)->takeOversView('account/components/namespace/user/takeOver/list') }}
                <div class="p-2"></div>
            </div>
            <div class="p-2"></div>
        </div>
