...
namespace App\Domain\Aggregate\Metrics\Ranking;
        ...
        foreach ($grns as $grn) {
            ...
            $grnKeys = GrnKeyLoader::load(
                ...
                GrnKeyLoader::buildQuery(
                    $service,
                    ['categoryModel', 'categoryName', 'request'],
                    $this->table(),
                    $userId,
                    $this->timeRange(),
                    [
            ...
            $categoryModelModels = GrnLoader::load(
                $this->createClient(),
                new \App\Models\Grn([
                    'grn' => "{$grn['grn']}:user:$userId",
                    'parent' => $grn['grn'],
            ...
            $totalBytesProcessed += $categoryModelModels->totalBytesProcessed;
        }
